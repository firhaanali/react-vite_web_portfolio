...
const Hero = () => {
  ...
  const handleDownload = async (e) => {
    ...
    try {
      const response = await fetch(heroData.ctaPrimary.href);
              ...
              <div className="mt-6" data-aos="fade-up">
                ...
                <div className="flex flex-wrap gap-3 justify-start">
                  {heroData.stats.map((stat) => (
                    <div
                      key={stat.id}
                      className="flex items-center space-x-2 px-3 py-2 bg-white dark:bg-gray-800 rounded-full shadow-md dark:shadow-gray-900/30 border border-gray-300 dark:border-gray-700 hover:border-gray-900 dark:hover:border-white hover:shadow-lg hover:-translate-y-[5px] transition-all duration-300"
                    >
