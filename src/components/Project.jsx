...
const projectsData = [
    ...
    },
    {
        ...
        description: "Real-time e-commerce and sales dashboard for D'Busana fashion brand, integrated with marketplace data, performance metrics, and stock analysis.",
        technologies: ["React.js", "Node.js", "PostgreSQL", "Prisma", "Vite", "Express.js"],
        icon: "bx bx-line-chart",
        github: "https://github.com/firhaanali/dashboard_dbusana",
        live: null,
        color: "#6610f2"
    },
    {
        id: 5,
        title: "D'Busana Mobile Dashboard",
        category: "Frontend",
        description: "Mobile-optimized dashboard for D'Busana fashion brand, providing real-time sales, inventory, and performance analytics.",
        technologies: ["React Native", "Tailwind CSS", "Axios", "Chart.js"],
        icon: "bx bx-cloud",
